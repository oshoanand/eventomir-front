  ...
  return (
    <div className="flex flex-col min-h-[100dvh] bg-background w-full overflow-x-hidden relative">
      {/* Always render the Header. 
        On mobile chat screens, the ChatDetailScreen uses `fixed inset-0 z-[100]` to perfectly cover it.
        On laptop chat screens, it sits naturally at the top.
      */}
      <ClientHeader />
      ...
      {/* Always render the Footer on desktop (hidden on mobile via Tailwind).
        The ChatDetailScreen's desktop layout calculates its height to fit perfectly above this footer.
      */}
      ...
      {/* BottomNav remains visible on mobile. 
          The ChatDetailScreen's fixed inset-0 overlay will naturally cover it when a specific chat opens. */}
      <BottomNav />
    </div>
  );
};
