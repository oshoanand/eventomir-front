...
// Standardized Interface to handle both Orders (Paid) and Invitations (Free)
...
export default function MyTicketsPage() {
  ...
  // Ensure the query handles the combined data from the backend
  ...
  const handleAction = async (
    ...
    try {
      // Endpoint handles both Order IDs and Invitation IDs based on type
      const endpoint =
        ticket.type === "ORDER"
        ...
        <div className="grid gap-6">
          {tickets.map((ticket: UnifiedTicket) => {
            ...
            return (
              ...
              >
                {/* Image Section */}
                <div className="sm:w-1/3 h-48 sm:h-auto relative bg-muted group">
                  <img
                ...
                {/* Content Section */}
                <div className="sm:w-2/3 p-6 flex flex-col justify-between bg-card">
                  <div>
                    ...
                    <div className="space-y-2.5">
                      <div className="flex items-center gap-2.5 text-sm font-medium">
                        ...
                        <span className="text-foreground/80">
                          {format(new Date(ticket.date), "dd MMMM yyyy", {
                            locale: ru,
                          })}
                        </span>
                        {ticket.time && (
                    ...
                    {status.label === "Активен" && (
                      <div className="flex gap-2 w-full sm:w-auto">
                        ...
                        <Button
                          ...
                          onClick={() => handleAction(ticket, "download")}
                          disabled={isProcessing}
                        >
                          {isProcessing ? (
                            <Loader2 className="h-4 w-4 animate-spin" />
