...
// // Updated imports from @services/performer
// import {
//   PerformerProfile,
//   GalleryItem,
//   usePerformerProfile,
...
// // NEW: Import the subscription status card
...
// // import SubscriptionManager from "@/components/SubscriptionManager"; // Removed as we use the new card now
...
//         variant: "destructive",
//         title: "Ошибка",
//         description: "Войдите в систему и выберите дату.",
//       });
//       return;
//     }
...
//   // --- Content Handlers (Using Mutations) ---
...
//       removeGalleryItemMutation.mutate({ performerId: profile.id, itemId });
//     }
//   };
...
//   const handleDeleteCertificate = (itemId: string) => {
//     if (!profile) return;
//     if (confirm("Удалить сертификат?")) {
//       removeCertificateMutation.mutate({ performerId: profile.id, itemId });
//     }
//   };
...
//   const handleDeleteLetter = (itemId: string) => {
//     if (!profile) return;
//     if (confirm("Удалить письмо?")) {
//       removeLetterMutation.mutate({ performerId: profile.id, itemId });
//     }
//   };
...
//             <DialogDescription>
//               Выберите дату и опишите детали.
//             </DialogDescription>
//           </DialogHeader>
...
//                   const isBooked = profile.bookedDates?.some(
...
//             description="Загрузите фото работы."
